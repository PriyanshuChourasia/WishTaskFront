...
export const WorkspaceHeader: React.FC<WorkspaceHeader> = ({data,isLoading}) =>{
    ...
    return(
        <div className="w-full flex items-center justify-between px-4 py-2 rounded-md border-2 border-gray-200 hover:border-gray-600 transition-all duration-200 ease-in shadow-sm hover:shadow-xl ">
